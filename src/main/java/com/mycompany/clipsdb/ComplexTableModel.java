...
public class ComplexTableModel extends AbstractTableModel {
   ...
   static final String DB_URL = "jdbc:h2:file:./data/myclips";
   ...
   static final String PASS = "";
    ...
    public static void main(String[] args) {
        try {
            ...
            String query = "SELECT Actors.ActorFamily, Actors.ActorName, Actors.ActorSoname, Clips.ClipName, Clips.ClipTheme " + 
                  "FROM Actors, Clips " + 
                  "WHERE Clips.ClipActorID = Actors.ActorID";       
            ...
            ComplexTableModel model = new  ComplexTableModel();
            ...
            JFrame frame = new JFrame("Complex Table Model");
